                ...
                <div class="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                    ...
                    <div class="flex justify-end space-x-2">
                        <button onclick="editOverhead(<?php echo htmlspecialchars(json_encode($overhead)); ?>)" 
                                class="px-3 py-1 text-xs bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors">
                            Edit
                        </button>
                        <button onclick="deleteOverhead(<?php echo $overhead['id']; ?>, '<?php echo htmlspecialchars($overhead['name']); ?>')" 
                                class="px-3 py-1 text-xs bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors">
                            Hapus
                        </button>
                    </div>
                </div>
                            ...
                            <form action="/cornerbites-sia/process/simpan_overhead.php" method="POST">
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="overhead_amount" name="amount" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="500000" min="0" required>
                                    </div>
                            ...
                            <div class="bg-gray-50 rounded-lg p-3 mb-4">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                    <div>
                                        ...
                                        <input type="text" id="search-overhead-input" value="<?php echo htmlspecialchars($search_overhead); ?>" placeholder="Cari nama overhead..." class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    </div>
                                    <div>
                                    ...
                                    <div class="flex items-end gap-2">
                                        <button id="filter-overhead-btn" class="px-3 py-2 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors">Filter</button>
                                        <button id="reset-overhead-btn" class="px-3 py-2 text-sm bg-gray-500 hover:bg-gray-600 text-white rounded-lg transition-colors">Reset</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <form action="/cornerbites-sia/process/simpan_overhead.php" method="POST">
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="labor_hourly_rate" name="hourly_rate" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="15000" min="0" required>
                                    </div>
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="bg-gray-50 rounded-lg p-3 mb-4">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                    <div>
                                        <label class="block text-xs font-medium text-gray-700 mb-1">Pencarian</label>
                                        <input type="text" id="search-labor-input" value="<?php echo htmlspecialchars($search_labor); ?>" placeholder="Cari posisi tenaga kerja..." class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-gray-700 mb-1">Per Halaman</label>
                                    ...
                                    <div class="flex items-end gap-2">
                                        <button id="filter-labor-btn" class="px-3 py-2 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors">Filter</button>
                                        <button id="reset-labor-btn" class="px-3 py-2 text-sm bg-gray-500 hover:bg-gray-600 text-white rounded-lg transition-colors">Reset</button>
                                    </div>
                                </div>
                            </div>
                        </div>
